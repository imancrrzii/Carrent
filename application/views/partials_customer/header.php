...
<link rel="stylesheet" href="<?= base_url('assets/shop') ?>/css/theme.css">
<link rel="stylesheet" href="<?= base_url('assets/shop') ?>/css/loopple/loopple.css">
<link rel="shortcut icon" href="<?php echo base_url('assets') ?>/connected-car.png">
